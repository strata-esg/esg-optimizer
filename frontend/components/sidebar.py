...
def render_sidebar() -> None:
    with st.sidebar:
        ...
        _nav("Accueil", "pages/0_Accueil.py", "nav_accueil")
        if is_logged_in():
            _nav("Upload", "pages/2_Upload.py", "nav_upload")
            _nav("Résultats", "pages/3_Resultats.py", "nav_resultats")
            _nav("Dashboard", "pages/4_Dashboard.py", "nav_dashboard")
            _nav("Paramètres", "pages/5_Parametres.py", "nav_parametres")
