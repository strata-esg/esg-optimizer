---
title: "Les 10 erreurs à éviter dans votre rapport ESG"
slug: 10-erreurs-reporting-esg
description: "Analyse de 200+ rapports ESG : les 10 erreurs qui font systématiquement échouer la certification CSRD. Check-list pratique et correctifs."
author: "Équipe ESG Optimizer"
date: 2026-04-20
category: "Best practices"
tags: ["ESG", "reporting", "CSRD", "ESRS", "audit", "erreurs fréquentes"]
og_image: "https://esg-optimizer.fr/static/blog/10-erreurs.png"
canonical: "https://esg-optimizer.fr/blog/10-erreurs-reporting-esg"
reading_time: "9 min"
---
...
**Ce qui est attendu** : une section dédiée qui explicite la méthodologie d'analyse (parties prenantes consultées, seuils de matérialité, critères d'impact et de matérialité financière), une matrice visuelle, et un tableau des enjeux matériels retenus avec justification.
...
**Ce qui est attendu** : « Nos émissions Scope 1+2 (market-based) en 2024 s'élèvent à 2 340 tCO2e, en baisse de 12 % vs 2023, pour un chiffre d'affaires de 18,4 M€, soit une intensité carbone de 127 kg CO2e / k€ de CA. »
...
**Ce qui est attendu (ESRS E1 §51-56)** : identification des catégories Scope 3 pertinentes, méthode de calcul pour chacune (monétaire, physique, hybride), pourcentage de couverture, plan d'amélioration si incomplet.
...
**Ce qui est attendu** : pour chaque KPI social, ventilation par genre, par CSP, par site géographique, par type de contrat. Y compris pour les indicateurs qui vous sont défavorables. Un rapport qui ne montre que les bons chiffres perd tout crédit.
...
**Ce qui est attendu (ESRS 2 §40 a-j)** : chaque enjeu matériel doit avoir un **plan d'action** comprenant : objectif quantifié, horizon temporel, ressources allouées (€, ETP), responsable nommé, indicateurs de suivi, étapes intermédiaires.
...
**Ce qui est attendu (ESRS G1 + ESRS 2)** : description du dispositif de gouvernance ESG (comité au board, fréquence des revues, compétences spécifiques des administrateurs), intégration de critères ESG dans la rémunération variable des mandataires, procédure de remontée des alertes.
...
**Ce qui est attendu (ESRS S2 + E1 §49 Scope 3 Cat. 1)** : cartographie des fournisseurs par catégorie, pourcentage couvert par un audit ou une évaluation ESG, enjeux matériels identifiés (travail forcé, émissions, biodiversité selon secteur), mesures correctives.
...
**Ce qui est attendu** : **connexion explicite** entre les KPI ESG et les données financières publiées. La CSRD impose que le rapport de durabilité soit intégré au rapport de gestion, donc cohérent avec lui. L'alignement taxonomie UE (part verte du CA, CapEx, OpEx) doit être réconcilié avec la liasse financière.

**Correctif** : faites relire votre brouillon ESG par votre DAF. Si les chiffres ne se reparlent pas, retravaillez.

---

## Check-list de pré-audit (à imprimer)

- [ ] Analyse de double matérialité documentée avec matrice visuelle
- [ ] > 60 % des affirmations appuyées par des chiffres sourcés
- [ ] Scope 3 : au moins les catégories matérielles identifiées, méthode explicitée
- [ ] Trajectoire 2030 et 2050 quantifiée en tonnes CO2e
- [ ] Indicateurs sociaux ventilés par genre, CSP, site
- [ ] Plan d'action avec objectifs, responsables, budgets, deadlines
- [ ] Dispositif de gouvernance ESG décrit (comité, rémunération variable)
- [ ] Risques climatiques physiques analysés sur 3 horizons
- [ ] Chaîne de valeur : cartographie + % de fournisseurs évalués
- [ ] Cohérence financier ↔ extra-financier vérifiée avec le DAF

---

## Envie de savoir où vous en êtes, en 3 minutes ?
...
*Méthodologie : observation sur 200+ rapports soumis à ESG Optimizer de octobre 2025 à avril 2026. Sources normatives : EFRAG ESRS Set 1, GHG Protocol, TCFD recommendations, SBTi SME Target Setting Criteria V2.0.*
